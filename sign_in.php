...
require_once('login-with-google/config.php');
require_once('login-with-google/core/controller.Class.php');
?>
        ...
        <div class="forms-container">
            <div class="signin-signup">
                <form action="logic/auth.php" class="sign-in-form" method="post">
                    ...
                    <p class="social-text"> Или войти с помощью Google</p>

                    <div class="social-media">
                        <a href="<?php echo $login_url; ?>" class="social-icon">
